...
| Domínio | Fase 1 | Futuro |
| --- | --- | --- |
| Perfil | Administrador técnico, adulto e personagem fictício | Conta, família, consentimento |
| Carteira/extrato | Saldo e eventos | Relatórios |
| Recebimento | Pig Bank concede | Economia ampliada |
| Envio | Simulação sem P2P infantil | Nova decisão obrigatória |
| Mineração | 2 atividades curtas | Curva e ciclos |
| Patrimônio | Terreno Inicial limitado | Imóveis, reformas, títulos |
| Cartório | Conceito | Titularidade e avaliações |
