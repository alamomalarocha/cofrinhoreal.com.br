...
const metadata = (html, route) => {
  ...
  const additions = `<link rel="canonical" href="${canonical}" /><meta property="og:url" content="${canonical}" /><meta property="og:site_name" content="Cofrinho Real" /><meta property="og:type" content="website" /><meta property="og:image" content="https://cofrinhoreal.com.br/assets/characters/001-pig-principal.png?v=45" /><meta name="twitter:card" content="summary_large_image" /><link rel="apple-touch-icon" href="assets/favicon.svg" /><script type="application/ld+json">${JSON.stringify({"@context":"https://schema.org","@type":"WebSite",name:"Cofrinho Real",url:"https://cofrinhoreal.com.br/"})}</script>`;
...
const forbidden = /(^|\/)(?:docs|scripts|tests|data\/image-automation)(?:\/|$)|(?:^|\/)(?:package(?:-lock)?\.json|README\.md|\.env)(?:$|\/)/iu;
