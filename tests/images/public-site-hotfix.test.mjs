...
test("every public header uses the approved Pig and no legacy raster logo",()=>{for(const page of pages){assert.match(page,/header-logo[^>]+assets\/characters\/001-pig-principal\.png\?v=46/u);assert.match(page,/header-wordmark/u);assert.doesNotMatch(page,/assets\/brand\/cofrinho-real-logo-header/u);}assert.match(pages[0],/og:image[^>]+001-pig-principal\.png\?v=46/u);});
